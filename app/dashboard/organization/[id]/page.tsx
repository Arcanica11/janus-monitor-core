...
import { Building2, Globe, Users, CloudCog } from "lucide-react";
...
export default async function OrganizationPage({ params }: PageProps) {
  ...
  const { organization, subscriptions, assets, corporateEmails, members } =
    data;
      ...
      <Tabs defaultValue="infra" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="infra" className="gap-2">
            <CloudCog className="w-3 h-3" /> Servicios y Accesos
          </TabsTrigger>
